...
    { name: '멜론', category: '과일', icon: '🍈', description: '부드럽고 달콤한 과육이 특징.' },
    { name: '리치', category: '과일', icon: '⚪', description: '독특하고 향긋한 단맛을 가진 열대과일.' }, // 아이콘 수정
...
    { name: '용과', category: '과일', icon: '🐉', description: '이국적인 느낌을 더해주는, 부드럽고 은은한 단맛의 베이스 향료.' },
    // --- 새로 추가된 향료 (과일) ---
    { name: '코코넛', category: '과일', icon: '🥥', description: '부드럽고 크리미한 열대과일의 정수. 피나콜라다의 핵심 재료.' },
...
    { name: '마카롱', category: '디저트', icon: '🍪', description: '아몬드의 고소함과 달콤한 필링이 특징인 고급 디저트.' },
    // --- 새로 추가된 향료 (디저트) ---
    { name: '브라우니', category: '디저트', icon: '🟫', description: '진하고 꾸덕한 초콜릿의 결정체. 견과류와 환상적인 궁합을 자랑합니다.' },
...
    { name: '블랙 캐빈디쉬', category: '연초', icon: '⚫', description: '증기 압축 방식으로 처리하여 매우 부드럽고, 바닐라와 럼 같은 달콤한 향이 특징입니다.' },
    // --- 새로 추가된 향료 (연초) ---
    { name: '체리 연초', category: '연초', icon: '🍒', description: '잘 숙성된 연초에 달콤한 체리 향을 더해 부드러움을 극대화했습니다.' },
...
    { name: '탄산수', category: '음료', icon: '💦', description: '상쾌한 청량감을 더해주는, 맛이 없는 탄산수.' },
    // --- 새로 추가된 향료 (음료) ---
    { name: '모히토', category: '음료', icon: '🍹', description: '라임과 민트의 상쾌한 조화. 럼 베이스 칵테일의 상징.' },
...
    { name: '소금', category: '특별', icon: '🧂', description: '단맛을 증폭시키고, 맛의 균형을 잡아주는 마법의 재료.' },
    // --- 새로 추가된 향료 (특별) ---
    { name: '생강', category: '특별', icon: '🫚', description: '톡 쏘는 알싸함과 따뜻한 향. 레몬이나 꿀과 섞어 독특한 맛을 냅니다.' },
];
...
    '유자 에이드': { ingredients: ['유자', '꿀', '탄산수'], bonus: 1.5, type: '음료' },
    // --- 새로 추가된 레시피 10종 ---
    '트로피컬 선셋': { ingredients: ['망고', '코코넛', '패션후르츠'], bonus: 1.8, type: '과일' },
    '솔티드 카라멜 브라우니': { ingredients: ['브라우니', '카라멜', '소금'], bonus: 1.9, type: '디저트' },
    '클래식 모히토': { ingredients: ['모히토', '라임', '탄산수'], bonus: 1.6, type: '음료' },
    '진저 레몬 티': { ingredients: ['생강', '레몬', '꿀'], bonus: 1.7, type: '음료' },
    '체리 파이프': { ingredients: ['체리 연초', '파이프 연초', '바닐라'], bonus: 1.8, type: '연초' },
    '블루베리 치즈 타르트': { ingredients: ['블루베리', '치즈케이크', '버터스카치'], bonus: 1.9, type: '디저트' },
    '수박 스매시': { ingredients: ['수박', '라임', '스피어민트'], bonus: 1.6, type: '과일' },
    '아이리쉬 커피': { ingredients: ['커피', '버번', '크림'], bonus: 1.8, type: '음료' },
    '로즈 리치 에이드': { ingredients: ['장미', '리치', '엘더플라워'], bonus: 2.0, type: '음료' },
    '피스타치오 마카롱': { ingredients: ['피스타치오', '마카롱', '아몬드'], bonus: 1.9, type: '디저트' },
};
