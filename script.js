...
.flavor-item { transition: all 0.1s ease-in-out; border: 2px solid transparent; cursor: pointer; }
.flavor-item.selected { background-color: #4338ca; border-color: #818cf8; transform: scale(1.05); }
